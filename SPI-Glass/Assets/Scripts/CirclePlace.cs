...
public class CirclePlace : MonoBehaviour
{
    ...
    private void TryPlacePrefab()
    {
        ...
        if (furthestValidPlane != null)
        {
            ...
            // Apply the rotation to face the camera and rotate 90 degrees around the Y-axis
            Quaternion lookRotation = Quaternion.LookRotation(directionToCamera);
            Quaternion additionalRotation = Quaternion.Euler(0, 90, 0); // Rotate 90 degrees around Y-axis
            instantiatedPrefab.transform.rotation = lookRotation * additionalRotation;
